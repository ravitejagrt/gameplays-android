                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(getApplicationContext(), text: "Login Fail", Toast.LENGTH_LONG).show();
                            progressBar.setVisibility(View.GONE);
                        }

                        if (!task.isSuccessful()) {
//                            Toast.makeText(getApplicationContext(), text: "Login failed! Please try again", Toast.LENGTH_LONG).show();
                        }
                    }
                });
    }
